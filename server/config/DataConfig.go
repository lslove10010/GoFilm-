...
const (
	...
	MysqlDsn = "freefilm:lKeRJxFZHQPTd8m5@(mysql.sqlpub.com)/freefilm?charset=utf8mb4&parseTime=True&loc=Local"
	...
	*/
	...
	RedisAddr     = `redis-11825.c295.ap-southeast-1-1.ec2.redns.redis-cloud.com:11825`
	RedisPassword = `FeSvFCcuP2rlFVc7aemv8tq4vecAHIsW`
	RedisDBNo     = 0
